...
> [!NOTE] 
> Le projet doit être abordé comme un système dynamique où chaque composant est interconnecté. Comprendre ces interdépendances permet de mieux identifier l'origine des problèmes et de s'adapter aux imprévus avec résilience.
> 
...
> [!NOTE] 
> La création de valeur (qu'elle soit financière, sociale ou liée au bien-être) est le critère ultime de réussite. 
> 
> Le projet doit rester constamment aligné avec ses objectifs métiers, souvent définis dans le cas d'affaire (_business case_) qui permet la justification, en cherchant à maximiser cette valeur de bout en bout.
> 
> *Exemple de (business case)* :  on débloque 1 millions d'euros POUR une meilleur comptabilité
...
> 
> Il exige de l'intégrité, de l'humilité, de la conscience de soi et de la flexibilité. Ce rôle n'est pas figé et peut être partagé au sein de l'équipe selon les besoins du moment.
